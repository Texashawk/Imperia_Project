...
class ProjectButton : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    public void Awake()
    {
        ...
        hoverContent = GameObject.Find("Hover_Content");
        hoverMaxObject = transform.Find("Hover_Content/Hover_Maximize").GetComponent<Image>();
        hoverText = transform.Find("Hover_Content/Hover_Text_Status").GetComponent<TextMeshProUGUI>();
    ...
    public void Start()
    {            
        buttonGrid = GameObject.Find("Create_pressed_Types_Grid").GetComponent<GridLayoutGroup>();
